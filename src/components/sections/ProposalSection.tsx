      ...
      <div ref={sectionRef} className="relative z-10 mx-auto max-w-[1200px] px-4 md:px-8">
        ...
        <div className="mt-32 grid items-center gap-12 md:mt-48 lg:grid-cols-12 lg:gap-16">
          ...
          <motion.a
            ...
            target="_blank"
            rel="noreferrer"
            className={`group relative order-1 mx-auto block w-full max-w-sm overflow-hidden rounded-[8px] shadow-[0_32px_64px_rgba(36,41,31,0.12)] lg:order-2 lg:col-span-4 lg:max-w-none ${!humorBeat ? 'lg:col-start-5' : ''}`}
          >
